...
class Vendor(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.pk:
            # Check if the is_approved field has been changed
            ...
            if orig.is_approved != self.is_approved:
                ...
                if self.is_approved:
                    #Send notification to vendor that their restaurant has been approved
                    mail_subject = "Your restaurant has been approved"
                else:
                    #Send notification to vendor that their restaurant has been disapproved
                    mail_subject = (
